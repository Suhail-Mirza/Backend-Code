...
class homeControllers{
    ...
    get_products = async (req,res)=>{
        ...
        try{
            ...
            const allProduct1 = await productModel.find({}).limit(12).sort({createdAt :-1})
            ...
            responseReturn(res,200,{products,latest_product,discount_product})
        }catch(error){
    ...
    price_range_product = async(req,res)=>{
        ...
        try{
            ...
            if(getForPrice.length>0){
                ...
                priceRange.ow = getForPrice[0].price
            }
