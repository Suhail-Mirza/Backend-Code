...
const stripe = require('stripe')('sk_test_51Rlxy9I5tvgzviVcGyokuUq4KP91jOm4IbUUyBq8CBgEwbAG7aM21new6KRMHTdL7F18DwV8bmTy50FyVuN7VghB00UsyJ5R7F')
...
class orderController{
 ...
 get_admin_orders = async(req, res) => {
  ...
  order_confirm = async (req,res) => {
    const {orderId} = req.params
    try {
        await customerOrder.findByIdAndUpdate(orderId, { payment_status: 'paid', delivery_status: 'placed' })
